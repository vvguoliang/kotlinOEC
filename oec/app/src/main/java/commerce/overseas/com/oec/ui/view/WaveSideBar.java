...
/**
 * @Time : 2018/3/23 no 下午5:51
 * @USER : vvguoliang
 * @File : WaveSideBar.java
...
public class WaveSideBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mTextSize = context.getResources().getDimensionPixelSize(R.dimen.commont_dp10);
        mHintTextSize = context.getResources().getDimensionPixelSize(R.dimen.commont_dp32);
        mPadding = context.getResources().getDimensionPixelSize(R.dimen.commont_dp20);
        if (attrs != null) {
            ...
            mRadius = a.getDimensionPixelSize(R.styleable.waveSideBar_radius, context.getResources().getDimensionPixelSize(R.dimen.commont_dp20));
            mCircleRadius = a.getDimensionPixelSize(R.styleable.waveSideBar_circleRadius, context.getResources().getDimensionPixelSize(R.dimen.commont_dp24));
            a.recycle();
        }
